...
<head>
    ...
    <style>
        ...
        .btn-outline { border: 1px solid #007bff; color: #007bff; background: #fff; padding: 4px 12px; border-radius: 4px; transition: background 0.2s, color 0.2s; text-decoration: none;}
        .btn-outline:hover { background:rgb(84, 104, 126); color: #fff;}
    </style>
</head>
<body>
        ...
        <section class="content-section">
            ...
            <form method="GET" class="filter-form" style="margin-bottom: 1.5em; display: flex; gap: 1em;">
                ...
                <?php if ($abuse_type || $victim_name || $status || $report_date): ?>
                    <a href="lawyer_cases.php" class="btn1" style="background:#ccc;color:#222;">Clear</a>
                <?php endif; ?>
            </form>
                    ...
                    <tbody>
                        <?php foreach ($cases as $case): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-outline" href="law_view_details.php?case_id=<?= $case['case_id'] ?>">View Details</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
